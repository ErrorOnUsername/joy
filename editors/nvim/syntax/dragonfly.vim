...
" Keywords
"
syn keyword df_conditionals    if else match
...
syn keyword df_type            nothing bool byte ibyte word iword long ilong quad iquad usize isize flong fquad string cstring rawptr
